...
(function() {
	...
	*/
	function onData( addend ) {
		...
		* @param {Function} clbk - callback to invoke after performing addition. Function accepts two arguments: [ error, chunk ].
		*/
	...
	*
	* @param {Number} value - addend (the value to be added to streamed values)
